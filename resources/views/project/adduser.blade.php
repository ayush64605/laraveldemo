...
<x-pannel-layout>
    ...
    <section>
        <div>
            ...
            <form action="{{ route('project.user.save', ['project' => $project->id]) }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-900">User Name <span
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-900">User Email<span
                                class="text-red-600">*</span>
                        </label>
