...
<x-app-layout>
    ...
    <section class="flex justify-center gap-4 mt-5">
        <div class="border-2 border-stone-200 rounded-lg p-10 shadow-xl">
            ...
            <form class="w-[500px]" action="{{ route('tag.save') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <h2 class="text-lg font-semibold text-gray-900">
                    {{ isset($projectcategory) ? 'Edit Tag' : 'Add Tag' }}
                </h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Enter Tag name"
