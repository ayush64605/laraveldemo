<nav x-data="{ open: false }" class="bg-indigo-100 border-b border-gray-100">
            ...
            @if (Auth::user())
                <div class="flex items-center">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="{{ route('dashboard') }}" class="text-2xl font-semibold text-black">
                           PMS
                        </a>
                    </div>
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('project.show')" :active="request()->routeIs('project.*')">
                            {{ __('Projects') }}
                        </x-nav-link>
                    </div>
