...
<body>
    <section class="flex justify-center gap-4 mt-40">
        <div class="border-2 border-solid rounded-lg border-stone-200 p-15 shadow-xl">
            <form class="w-100" action="{{ route('employee.loginprocess') }}" method="POST">
                @csrf
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-4">
                        <h2 class="text-lg/10 font-semibold text-gray-900">Employee Login</h2>
