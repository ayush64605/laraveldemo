        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <p class="text-sm text-[#706f6c] dark:text-[#A1A09A] mb-6">
                    Manage your projects, tasks, and teams efficiently from one powerful dashboard.
                </p>

                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                    <div class="border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm p-4">
                        <h3 class="font-medium mb-1">📁 Projects</h3>
                    ...
                    <div class="border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm p-4">
                        <h3 class="font-medium mb-1">✅ Tasks</h3>
                        <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">
                            Assign, track, and complete tasks faster.
                        </p>
                    </div>

                    <div class="border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm p-4">
                        <h3 class="font-medium mb-1">👥 Team</h3>
                        <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">
